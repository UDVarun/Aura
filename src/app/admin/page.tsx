...
const RECENT_ORDERS = [
    ...
    { id: "#ORD-1920", customer: "Maria Garcia", product: "Mechanical Keyboard", amount: "$159.99", status: "processing" },
    { id: "#ORD-1919", customer: "James Lee", product: "Smart Home Speaker", amount: "$249.50", status: "shipped" },
    { id: "#ORD-1918", customer: "Sarah Kim", product: "Ceramic Table Lamp", amount: "$89.00", status: "pending" },
    { id: "#ORD-1917", customer: "Mike Torres", product: "Laptop Stand Pro", amount: "$79.99", status: "delivered" },
];
        ...
        <div className={styles.page}>
            <div className={styles.pageHeader}>
                ...
                <div className={styles.headerActions}>
                    <span className={styles.dateStr}>{new Date().toLocaleDateString("en-US", { weekday: "long", year: "numeric", month: "long", day: "numeric" })}</span>
                </div>
            </div>
